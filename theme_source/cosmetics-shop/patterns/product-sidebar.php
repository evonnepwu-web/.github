<?php
  ...
  * Slug: cosmetics-shop/product-sidebar
  * Categories: cosmetics-shop-sidebar
  */
?>
...
<h3 class="wp-block-heading has-big-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Filter by price', 'cosmetics-shop' ); ?></h3>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading alignwide has-big-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Categories', 'cosmetics-shop' ); ?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-filter-wrapper"><!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"big"} -->
<h3 class="wp-block-heading has-big-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Active filters', 'cosmetics-shop' ); ?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-filter-wrapper"><!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"big"} -->
<h3 class="wp-block-heading has-big-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Filter by stock status', 'cosmetics-shop' ); ?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-filter-wrapper"><!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"big"} -->
<h3 class="wp-block-heading has-big-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Filter by attribute', 'cosmetics-shop' ); ?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-filter-wrapper"><!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"big"} -->
<h3 class="wp-block-heading has-big-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Filter by rating', 'cosmetics-shop' ); ?></h3>
<!-- /wp:heading -->
