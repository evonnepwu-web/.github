...
/**
 * Title: Hidden 404
 * Slug: cosmetics-shop/hidden-404
 * Categories: template
 */
?>
...
<h1 class="wp-block-heading has-text-align-center" style="font-size:43px"><?php echo esc_html__('Page Not Found', 'cosmetics-shop'); ?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php echo esc_html__('This page could not be found. Maybe try a search?', 'cosmetics-shop'); ?></p>
<!-- /wp:paragraph -->
