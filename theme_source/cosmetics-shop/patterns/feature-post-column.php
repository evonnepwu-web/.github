 ...
 * Slug: cosmetics-shop/feature-post-column
 * Categories: template
 */
?>
			...
			>
				...
				>
					...
					<h3
						...
						"
					>
					<?php echo esc_html__( 'Popular News', 'cosmetics-shop' ); ?>
					</h3>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
			...
			>
				...
				>
					...
					<h3
						...
						"
					>
					<?php echo esc_html__( 'Recent News', 'cosmetics-shop' ); ?>
					</h3>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
